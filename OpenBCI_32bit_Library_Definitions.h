...
/** Custom LeadOff Impedance Commands */
#define OPENBCI_CUSTOM_CHANNEL_IMPEDANCE_LATCH   'O'
#define OPENBCI_CUSTOM_CHANNEL_IMPEDANCE_SET     'o'
#define OPENBCI_CUSTOM_LEAD_OFF_CURRENT_MAG_6NA  '0'
#define OPENBCI_CUSTOM_LEAD_OFF_CURRENT_MAG_24NA '1'
#define OPENBCI_CUSTOM_LEAD_OFF_CURRENT_MAG_6UA  '2'
#define OPENBCI_CUSTOM_LEAD_OFF_CURRENT_MAG_24UA '3'
#define OPENBCI_CUSTOM_LEAD_OFF_FREQ_DC          '0'
#define OPENBCI_CUSTOM_LEAD_OFF_FREQ_7p8HZ       '1'
#define OPENBCI_CUSTOM_LEAD_OFF_FREQ_31p2HZ      '2'
#define OPENBCI_CUSTOM_LEAD_OFF_FREQ_FS_4        '3'
...
#define OPENBCI_NUMBER_OF_BYTES_SETTINGS_CUSTOM_LEAD_OFF 7
